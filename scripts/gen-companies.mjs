...
const companies = [
  ...
  // More IT Services
  ["coforge","Coforge","CF","#e11d48",60,50,"Easy",S,"Coforge Campus Test","IT Services","Software Engineer,Analyst"],
  ["mphasis2","Mastek","MK","#7c3aed",60,50,"Easy",S,"Mastek Campus Test","IT Services","Software Engineer,Analyst"],
  ["kpit","KPIT Technologies","KP","#16a34a",65,52,"Medium",S,"KPIT Campus Assessment","IT Services","Graduate Engineer,Software Analyst"],
  ["sasken","Sasken Technologies","SK","#0891b2",60,50,"Easy",S,"Sasken Campus Test","IT Services","Software Engineer,Embedded Engineer"],
  ["tata-comm","Tata Communications","TC","#00457c",70,55,"Medium",S,"Tata Communications Campus","IT Services","Software Engineer,Network Engineer"],
  ["steria","Sopra Steria","ST","#0284c7",70,55,"Medium",S,"Sopra Steria Campus","IT Services","Software Engineer,Associate Consultant"],
  ["dxc","DXC Technology","DX","#dc2626",70,55,"Medium",S,"DXC Technology Campus","IT Services","Software Engineer,Analyst"],
  ["csc","CSC (Hewlett Packard)","HP","#0171c5",70,55,"Medium",S,"HP Enterprise Campus","IT Services","Software Engineer,Technology Analyst"],
  ["ntt-data","NTT Data","ND","#1a56db",65,52,"Medium",S,"NTT Data Campus Test","IT Services","Software Engineer,Consultant"],
  ["cts-2","Cognizant Technology","CX","#0891b2",70,55,"Medium",S,"Cognizant Campus Advanced","IT Services","Programmer Analyst Trainee,Software Engineer"],
  // More Product / Tech
  ["vmware","VMware","VM","#607078",75,3,"Hard",SC,"VMware Campus OA","Product","Software Engineer,MTS"],
  ["workday","Workday","WD","#f7622b",70,3,"Hard",SC,"Workday Campus OA","Product","Software Engineer,Associate SWE"],
  ["splunk","Splunk","SL","#65a637",70,3,"Hard",SC,"Splunk Campus OA","Product","Software Engineer,Data Engineer"],
  ["twilio","Twilio","TW","#f22f46",60,2,"Hard",C,"Twilio Campus Assessment","Product","Software Engineer,Developer"],
  ["docusign","DocuSign","DS","#4c00ff",70,3,"Hard",SC,"DocuSign Campus OA","Product","Software Engineer,SWE"],
  ["zendesk","Zendesk","ZD","#03363d",70,3,"Hard",SC,"Zendesk Campus OA","Product","Software Engineer,SWE"],
  ["okta","Okta","OK","#007dc1",70,3,"Hard",SC,"Okta Campus OA","Product","Software Engineer,Security Engineer"],
  ["cloudflare","Cloudflare","CL","#f48120",70,3,"Hard",SC,"Cloudflare Campus OA","Product","Software Engineer,Network Engineer"],
  ["crowdstrike","CrowdStrike","CS","#e01f27",70,3,"Hard",SC,"CrowdStrike Campus OA","Product","Software Engineer,Security Engineer"],
  ["mongodb-co","MongoDB","MG","#00ed64",70,3,"Hard",SC,"MongoDB Campus OA","Product","Software Engineer,SWE"],
  ["elastic","Elastic","EL","#f04e98",70,3,"Hard",SC,"Elastic Campus OA","Product","Software Engineer,SWE"],
  ["hashicorp","HashiCorp","HC","#000000",70,3,"Hard",SC,"HashiCorp Campus OA","Product","Software Engineer,SWE"],
  ["figma","Figma","FG","#a259ff",70,3,"Hard",SC,"Figma Campus OA","Product","Software Engineer,Product Engineer"],
  ["notion","Notion","NT","#000000",70,3,"Hard",SC,"Notion Campus OA","Product","Software Engineer,SWE"],
  ["vercel","Vercel","VC","#000000",70,3,"Hard",SC,"Vercel Campus OA","Product","Software Engineer,Developer"],
  // More Indian Startups
  ["nykaa","Nykaa","NK","#fc2779",65,3,"Medium",SC,"Nykaa Tech Assessment","Startups","Software Engineer,SDE"],
  ["lenskart","Lenskart","LK","#1f5ead",65,50,"Medium",SC,"Lenskart Tech Campus","Startups","Software Engineer,Developer"],
  ["mpl","MPL","MP","#2b2b2b",60,2,"Hard",C,"MPL Platform Engineering OA","Startups","Software Engineer,SDE"],
  ["games24x7","Games24x7","G2","#e63946",60,2,"Hard",C,"Games24x7 Engineering OA","Startups","Software Engineer,Data Engineer"],
  ["chargebee","Chargebee","CB","#ff6b35",70,3,"Hard",SC,"Chargebee SDE Assessment","Startups","Software Engineer,SDE"],
  ["hasura","Hasura","HU","#1eb4d4",60,2,"Hard",C,"Hasura SDE OA","Startups","Software Engineer,SDE"],
  ["freshdesk","Freshdesk","FD","#ff5a54",70,3,"Hard",SC,"Freshdesk SDE OA","Startups","Software Engineer,SDE"],
  ["juspay","Juspay","JP","#2d9cdb",65,3,"Hard",SC,"Juspay SDE Assessment","Startups","Software Engineer,SDE"],
  ["niyo","Niyo","NY","#00b386",65,3,"Hard",SC,"Niyo Tech Assessment","Startups","Software Engineer,SDE"],
  // More BFSI
  ["bnp-paribas","BNP Paribas","BN","#009943",75,50,"Medium",SA,"BNP Paribas Technology","BFSI","Analyst,Technology Associate"],
  ["wells-fargo","Wells Fargo","WF","#cc0000",75,50,"Medium",SA,"Wells Fargo Campus","BFSI","Technology Analyst,Associate"],
  ["credit-suisse","UBS (Credit Suisse)","CS","#e40000",80,3,"Hard",SC,"UBS Technology OA","BFSI","Software Engineer,Analyst"],
  ["icbc","ICBC Technology","IC","#e41c1c",75,50,"Medium",SA,"ICBC Technology Campus","BFSI","Technology Analyst,Software Engineer"],
  ["standard-chartered","Standard Chartered","SC","#00aeef",75,50,"Medium",SA,"Standard Chartered Campus","BFSI","Analyst,Graduate Trainee"],
  // More Core Engineering
  ["caterpillar2","Cummins","CU","#e41c1c",90,70,"Medium",S,"Cummins Engineering Campus","Core Engg","Graduate Engineer Trainee,Engineer"],
  ["emerson","Emerson Electric","EM","#1a56db",90,70,"Medium",S,"Emerson Campus Assessment","Core Engg","Software Engineer,Controls Engineer"],
  ["abb","ABB","AB","#e41c1c",90,70,"Medium",S,"ABB Campus Assessment","Core Engg","Graduate Engineer,Software Engineer"],
  ["schneider","Schneider Electric","SE","#3dcd58",90,70,"Medium",S,"Schneider Electric Campus","Core Engg","Graduate Engineer,Software Engineer"],
  ["rockwell","Rockwell Automation","RA","#cc0000",90,70,"Medium",S,"Rockwell Automation Campus","Core Engg","Software Engineer,Automation Engineer"],
  ["3m","3M","3M","#e41c1c",90,70,"Medium",S,"3M Campus Assessment","Core Engg","Graduate Engineer,Software Engineer"],
]
