...
const PATTERN_BATCHES: Record<string, string[][]> = {
  ...
  "Core Engg": [
    ...
    ["Arrays & Pointers", "Memory Management", "Buffer Operations", "Circular Array", "Ring Buffer"],
    ["Sorting & Searching", "Binary Search", "Merge Sort", "Quick Sort", "Heap Sort"],
    ["String Processing", "C-style Strings", "Tokenization", "Parsing", "Encoding"],
    ["Data Structures", "Linked List", "Stack", "Queue", "Tree"],
    ["Math", "Integer Overflow", "Fixed Point", "Floating Point", "Precision"],
    ["Recursion", "Tail Recursion", "Divide & Conquer", "Memoization", "Iteration"],
    ["Graph Algorithms", "BFS", "DFS", "Shortest Path", "MST"],
    ["Dynamic Programming", "Subsequence", "Knapsack", "Coin Change", "Path Count"],
    ["System Patterns", "Producer Consumer", "Rate Limiting", "State Machine", "Event Driven"],
  ],
  "Default": [
